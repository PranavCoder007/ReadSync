...
const Book = require('./db/models/book'); // Assuming this is the Mongoose model for books
const books = require('./books.json'); // JSON data from books.json
const users = require('./user.json'); // JSON data from users.json
const UserModel = require('./db/models/user'); // Mongoose model for users
...
// Function to add a single user to the database with 2 random books
const addUserToDB = async (userData) => {
  try {
    // Select 2 random books from the books.json
    const selectedBooks = [];
    ...
    // Add the selected books to the user's books field
